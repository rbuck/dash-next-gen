...
public class Mix implements Iterable<Mix.Type> {
    ...
    public Mix(Properties properties) {
        ...
        int[] workloadMix = getIntegerArrayProperty(properties, "workload.mix", new int[0]);
        String[] workloadTag = getStringArrayProperty(properties, "workload.tag", new String[0]);
